...
export const APP_STRINGS = {
  ...
  fixtureScreen: {
    ...
    deleteAllFixturesDesc: 'Deleting this fixture will delete ALL fixtures for this category. You can regenerate them after.',
  ...
  matchScreen: {
    ...
    cannotStartMatchDesc: 'All matches in the previous round must be completed before starting this match.',
